            ...
            <div className="card-body d-flex flex-column">
              ...
              <div className="app-news-item flex-fill leaderboard">
                ...
                <ol className="list-group list-group-numbered list-group-flush">
                  <li class="list-group-ite d-flex justify-content-between align-items-start px-0">
                    <div className="ms-2 flex-fill">
                      <div className="app-country"><ReactCountryFlag countryCode="US" svg /> United States</div>
                  ...
                  <li class="list-group-ite d-flex justify-content-between align-items-start px-0">
                    <div className="ms-2 flex-fill">
                      <div className="app-country"><ReactCountryFlag countryCode="AU" svg /> Australia</div>
                      <div className="app-progress">
                        <div className="progress">
                          <div className="progress-bar" style={{ width: progress + '%' }} role="progressbar" aria-valuenow={{ progress }} aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                  ...
                  <li class="list-group-ite d-flex justify-content-between align-items-start px-0">
                    <div className="ms-2 flex-fill">
                      <div className="app-country"><ReactCountryFlag countryCode="CH" svg /> Switzerland</div>
                      <div className="app-progress">
                        <div className="progress">
                          <div className="progress-bar" style={{ width: progress + '%' }} role="progressbar" aria-valuenow={{ progress }} aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                  ...
                  <li class="list-group-ite d-flex justify-content-between align-items-start px-0">
                    <div className="ms-2 flex-fill">
                      <div className="app-country"><ReactCountryFlag countryCode="JP" svg /> Japan</div>
                      <div className="app-progress">
                        <div className="progress">
                          <div className="progress-bar" style={{ width: progress + '%' }} role="progressbar" aria-valuenow={{ progress }} aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                  ...
                  <li class="list-group-ite d-flex justify-content-between align-items-start px-0">
                    <div className="ms-2 flex-fill">
                      <div className="app-country"><ReactCountryFlag countryCode="DE" svg /> Germany</div>
                      <div className="app-progress">
                        <div className="progress">
                          <div className="progress-bar" style={{ width: progress + '%' }} role="progressbar" aria-valuenow={{ progress }} aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
